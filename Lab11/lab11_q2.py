...
class LinkedBinaryTree:
    ...
    def subtree_children_dist(self, curr_root):
        ...
        if curr_root is None:
            return
        elif curr_root.left is not None and curr_root.right is not None:
            lst[2] += 1
            return subtree_children_dist(self, curr_root.left, num_leaves, single, double)
            return subtree_children_dist(self, curr_root.right, num_leaves, single, double)
...
print(binary_tree1.subtree_children_dist(binary_tree1.root))